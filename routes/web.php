...
//Route::get('/products/{category}', 'ProductControllerFetch@showProductsByCategory')->name('products.category');
Route::get('/products/{subcategory}', 'ProductControllerFetch@showProductsBySubcategory')
...
//Route::delete('destroy/{id}', 'Admin\LinksController@destroy')->name('Orders.destroy');   
