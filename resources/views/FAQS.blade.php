@extends('layout')
@section('title') MamaScout - FAQ'S @endsection
        ...
        <div class="accordion md-accordion" id="accordionEx" role="tablist" aria-multiselectable="true">
          ...
          <div class="card p-3">
            ...
            <div id="collapseOne1" class="collapse show" role="tabpanel" aria-labelledby="headingOne1"
              ...
              <div class="card-body">
              Our products are made in our own workshop.
              </div>
            </div>
          ...
          <div class="card p-3 my-5">
            ...
            <div role="tab" id="headingOne1">
              <a data-toggle="collapse" data-parent="#accordionEx" href="#heading2"
                ...
                <p class="mb-0 dark-grey-text" style="float:left;">
                    <i class="far fa-question-circle"></i> Are your components are safe & durable ?
            ...
            <div id="heading2" class="collapse" role="tabpanel" aria-labelledby="heading2"
              data-parent="#accordionEx">
              <div class="card-body">
               Yes our components are safe and durable as these are
