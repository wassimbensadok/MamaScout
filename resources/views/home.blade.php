...
<!-- About Starts Here -->
 ...
 <div id="About" class="container-fluid" style="background:white;">
    <br><br>
      <div class="row">
        <div class="col-md-4">
        <img src=" {{asset('public/Img/4.jpg')}}" alt="" class="img-fluid" >
        </div>
        <div  align="center" class="col-md-8">
            <h1 class="black-text" style="font-weight:bold;">About Mama Scout Shop</h1>
            <div class="col-md-3" style=" border-bottom: 2px solid #003399;"></div>
            <div class="row my-5" style="font-size:30px;">
              <div class="col-md-6" >
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i>Respect for tradition and craftsmanship</li>
                    <li><i class="fab fa-pagelines"></i> Eco Friendly Products</li>
                    </ul>
              </div>
              <div class="col-md-6">
                    <ul align="left" style="list-style:none;">
                    <li><i class="fab fa-pagelines"></i> Promoting diversity</li>
...
<section id="Products" align="center">
    ...
    <div style=" border-bottom: 2px solid #bc1cd1;width:100px;margin-left:45%;"></div>
    <div  class="row "  >
      ...
      <div class="col-md-4 px-5">
          <img src=" {{asset('public/Uploads/Products/'.$item->image1)}}" alt="" class="img-fluid" >
            ...
            <a href="Shop/{{$item->url}}" class="btn btn-primary" style="background-color: blueviolet !important">Shop Now</a>
