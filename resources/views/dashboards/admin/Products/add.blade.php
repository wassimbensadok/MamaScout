                  ...
                  <li class="nav-item">
                    ...
                    <li class="nav-item">
                      <a class="nav-link" id="Category-tab" data-toggle="tab" href="#Category" role="tab" aria-controls="Category"
                        aria-selected="false">Item's Category</a>
                    </li>
                  <li class="nav-item">
                 ...
                 <div class="tab-pane fade" id="SEO" role="tabpanel" aria-labelledby="SEO-tab">
                  ...
                  <div class="tab-pane fade" id="Category" role="tabpanel" aria-labelledby="Category-tab">
                      ...
                      <div class="row" style="padding:30px;">
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                <label>The Category of the Product</label>
                                <select class="form-control" name="category" id="categorySelect">
                                    <option>What's the product category?</option>
                                    <option value="Scouting Clothes">Scouting Clothes</option>
                            ...
                            categorySelect.addEventListener('change', function() {
                                ...
                                if (selectedCategory in subCategories) {
                                    ...
                                    subCategories[selectedCategory].forEach(subCategory => {
                                        ...
                                        option.value = subCategory; // Set the value for subcategory
                                        subCategorySelect.add(option);
                                    });
                                } else {
                                    // Hide the sub-category select if no sub-categories found for the selected category
