    ...
    class booking    extends Controller
    {
        ...
        public function  order_proceed(Request $request)
        {
              $validation =$request->validate([
                      ...
                      'mno'=>'required|digits:8',

                       'alternativemno'=>'nullable',
                ...
                $Delivery_Address=$address1.','.$address2.'<br>'.$city.','.$state.','.$country.'<br>'.$pincode.','.$mno;
             /* Delivery Details*/
            ...
            /* Order Details Starts Here*/
                if(session('cart'))
                {
                    ...
                    foreach (session('cart') as $id => $details)
                    {
                        ...
                        '<br> Price:'.$details["Final_Price"].'<br> Size:'.$alternativemno=$request->input('alternativemno'));
            ...
            /*Order Details Ends Here*/
                 ...
                 else
                 {
    	                ...
    	                <p>Thank you for your order. We’ll send a confirmation when your order ships. Your estimated delivery date is 3-5 working days. If you would like to view the status of your order or make any changes to it, please visit Your Orders on <a href="https://www.test.com">MamaScout.com</a></p>
    	               ...
    	               '.$Delivery_Address.'</p>
    	                ...
    	                $emailcontent=array(
    	                    ...
    	                    ($loginid, $name,$id)
    	                    {
    	                        ...
    	                        ('Your MamaScout.com order '.$id.' is Confirmed');
    	                        $message->from('codetalentum@btao.in','MamaScout');
